...
class AdmobCore {
    ...
    static final String BANNER_INLINE_SMALL_STYLE = "BANNER_INLINE_SMALL_STYLE";
    static final String BANNER_INLINE_LARGE_STYLE = "BANNER_INLINE_LARGE_STYLE";
    ...
    void initAdmob(Context context, List<String> testDeviceList) {
    ...
    void initAdmob(Context context) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
            String processName = Application.getProcessName();
            String packageName = context.getPackageName();
            if (!packageName.equals(processName)) {
     ...
     */
    void setDisableAdResumeWhenClickAds(boolean disableAdResumeWhenClickAds) {
     ...
     **/
    void setOpenShowAllAds(boolean value) {
        Admob.isShowAllAds = value;
    }

    /**
     * Set tắt event log time load splash
     **/
    void setOpenEventLoadTimeLoadAdsSplash(boolean logTimeLoadAdsSplash) {
     ...
     **/
    void setOpenEventLoadTimeShowAdsInter(boolean logLogTimeShowAds) {
        this.logLogTimeShowAds = logLogTimeShowAds;
    }


    final boolean isLoadFullAds() {
 ...
 /**
      ...
      * @param id
      */
    void loadBanner(final Activity mActivity, String id) {
        final FrameLayout adContainer = mActivity.findViewById(R.id.banner_container);
        final ShimmerFrameLayout containerShimmer = mActivity.findViewById(R.id.shimmer_container_banner);
        if (!Admob.isShowAllAds || !isNetworkConnected()) {
    ...
    void loadBannerPlugin(Activity activity, ViewGroup layout, ViewGroup shimmer, BannerPlugin.Config config) {
     ...
     * Load quảng cáo Banner Trong Activity
     */
    void loadBanner(final Activity mActivity, String id, AdCallback callback) {
        final FrameLayout adContainer = mActivity.findViewById(R.id.banner_container);
        final ShimmerFrameLayout containerShimmer = mActivity.findViewById(R.id.shimmer_container_banner);
        if (!Admob.isShowAllAds || !isNetworkConnected()) {
            adContainer.setVisibility(View.GONE);
     ...
     */
    void loadBanner(final Activity mActivity, String id, Boolean useInlineAdaptive) {
        final FrameLayout adContainer = mActivity.findViewById(R.id.banner_container);
        final ShimmerFrameLayout containerShimmer = mActivity.findViewById(R.id.shimmer_container_banner);
        if (!Admob.isShowAllAds || !isNetworkConnected()) {
            adContainer.setVisibility(View.GONE);
     ...
     * Load quảng cáo Banner Trong Activity set Inline adaptive banners
     */
    void loadInlineBanner(final Activity activity, String id, String inlineStyle) {
     ...
     * Load quảng cáo Banner Trong Activity set Inline adaptive banners
     */
    void loadBanner(final Activity mActivity, String id, final AdCallback callback, Boolean useInlineAdaptive) {
        final FrameLayout adContainer = mActivity.findViewById(R.id.banner_container);
        final ShimmerFrameLayout containerShimmer = mActivity.findViewById(R.id.shimmer_container_banner);
        if (!Admob.isShowAllAds || !isNetworkConnected()) {
            adContainer.setVisibility(View.GONE);
     ...
     * Load quảng cáo Banner Trong Activity set Inline adaptive banners
     */
    void loadInlineBanner(final Activity activity, String id, String inlineStyle, final AdCallback callback) {
        final FrameLayout adContainer = activity.findViewById(R.id.banner_container);
        final ShimmerFrameLayout containerShimmer = activity.findViewById(R.id.shimmer_container_banner);
        if (!Admob.isShowAllAds || !isNetworkConnected()) {
            adContainer.setVisibility(View.GONE);
     ...
     */
    void loadCollapsibleBanner(final Activity mActivity, String id, String gravity) {
        final FrameLayout adContainer = mActivity.findViewById(R.id.banner_container);
        final ShimmerFrameLayout containerShimmer = mActivity.findViewById(R.id.shimmer_container_banner);
        if (!Admob.isShowAllAds || !isNetworkConnected()) {
            adContainer.setVisibility(View.GONE);
     ...
     */
    void loadBannerFragment(final Activity mActivity, String id, final View rootView) {
     ...
     * Load Quảng Cáo Banner Trong Fragment
     */
    void loadBannerFragment(final Activity mActivity, String id, final View rootView, final AdCallback callback) {
        final FrameLayout adContainer = rootView.findViewById(R.id.banner_container);
        final ShimmerFrameLayout containerShimmer = rootView.findViewById(R.id.shimmer_container_banner);
        if (!Admob.isShowAllAds || !isNetworkConnected()) {
            adContainer.setVisibility(View.GONE);
     ...
     */
    void loadBannerFragment(final Activity mActivity, String id, final View rootView, Boolean useInlineAdaptive) {
        final FrameLayout adContainer = rootView.findViewById(R.id.banner_container);
        final ShimmerFrameLayout containerShimmer = rootView.findViewById(R.id.shimmer_container_banner);
        if (!Admob.isShowAllAds || !isNetworkConnected()) {
            adContainer.setVisibility(View.GONE);
     ...
     * Load Quảng Cáo Banner Trong Fragment set Inline adaptive banners
     */
    void loadInlineBannerFragment(final Activity activity, String id, final View rootView, String inlineStyle) {
        final FrameLayout adContainer = rootView.findViewById(R.id.banner_container);
        final ShimmerFrameLayout containerShimmer = rootView.findViewById(R.id.shimmer_container_banner);
        if (!Admob.isShowAllAds || !isNetworkConnected()) {
            adContainer.setVisibility(View.GONE);
     ...
     * Load Quảng Cáo Banner Trong Fragment set Inline adaptive banners
     */
    void loadBannerFragment(final Activity mActivity, String id, final View rootView, final AdCallback callback, Boolean useInlineAdaptive) {
        final FrameLayout adContainer = rootView.findViewById(R.id.banner_container);
        final ShimmerFrameLayout containerShimmer = rootView.findViewById(R.id.shimmer_container_banner);
        if (!Admob.isShowAllAds || !isNetworkConnected()) {
            adContainer.setVisibility(View.GONE);
     ...
     * Load Quảng Cáo Banner Trong Fragment set Inline adaptive banners
     */
    void loadInlineBannerFragment(final Activity activity, String id, final View rootView, String inlineStyle, final AdCallback callback) {
        final FrameLayout adContainer = rootView.findViewById(R.id.banner_container);
        final ShimmerFrameLayout containerShimmer = rootView.findViewById(R.id.shimmer_container_banner);
        if (!Admob.isShowAllAds || !isNetworkConnected()) {
            adContainer.setVisibility(View.GONE);
     ...
     */
    void loadCollapsibleBannerFragment(final Activity mActivity, String id, final View rootView, String gravity) {
        final FrameLayout adContainer = rootView.findViewById(R.id.banner_container);
        final ShimmerFrameLayout containerShimmer = rootView.findViewById(R.id.shimmer_container_banner);
        loadCollapsibleBanner(mActivity, id, gravity, adContainer, containerShimmer);
    }
    ...
    boolean interstitialSplashLoaded() {
        return mInterstitialSplash != null;
    }

    InterstitialAd getmInterstitialSplash() {
     ...
     * Load ads in Splash
     */
    void loadSplashInterAds(final Context context, String id, long timeOut, long timeDelay, final InterCallback adListener) {
        isTimeDelay = false;
        isTimeout = false;
        if (!isNetworkConnected()) {
            ...
            if (AppPurchase.getInstance().isPurchased(context) || !Admob.isShowAllAds) {
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        if (adListener != null) {
    ...
    void loadSplashInterAds2(final Context context, String id, long timeDelay, final InterCallback adListener) {
        if (!isNetworkConnected() || AppPurchase.getInstance().isPurchased(context) || !Admob.isShowAllAds) {
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    if (adListener != null) {
    ...
    void loadSplashInterAdsFloor(final Context context, List<String> listID, long timeDelay, final InterCallback adListener) {
        if (!isNetworkConnected() || AppPurchase.getInstance().isPurchased(context) || !Admob.isShowAllAds) {
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
...
//                    }, 1500);
    ...
    void loadInterAds(Context context, String id, InterCallback adCallback) {
        if (AppPurchase.getInstance().isPurchased(context) || !Admob.isShowAllAds) {
     ...
     * Show ads inter
     */
    void showInterAds(Context context, InterstitialAd mInterstitialAd, final InterCallback callback) {
    ...
    private void showInterstitialAd(Context context, InterstitialAd mInterstitialAd, InterCallback callback) {
        if (!isShowInter || !Admob.isShowAllAds) {
            callback.onAdClosed();
            callback.onNextAction();
            return;
        }
     ...
     * Show ads inter noti
     */
    void showInterAdsNoti(Context context, InterstitialAd mInterstitialAd, final InterCallback callback) {
     ...
     */
    void loadAndShowInter(AppCompatActivity activity, String idInter, int timeDelay, int timeOut, InterCallback callback) {
        if (!isNetworkConnected()) {
            callback.onAdClosed();
            callback.onNextAction();
            return;
        }
        if (AppPurchase.getInstance().isPurchased(context) && !Admob.isShowAllAds && !isShowInter) {
            callback.onAdClosed();
            callback.onNextAction();
            return;
        }
    ...
    void loadAndShowInterNoti(AppCompatActivity activity, String idInter, int timeDelay, int timeOut, InterCallback callback) {
        if (!isNetworkConnected()) {
            callback.onAdClosed();
            callback.onNextAction();
            return;
    ...
    void showRewardAds(final Activity context, final RewardCallback adCallback) {
        if (!Admob.isShowAllAds || !isNetworkConnected()) {
        ...
        if (rewardedAd == null) {
            ...
            AdmobCore.this.rewardedAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                @Override
                public void onAdDismissedFullScreenContent() {
                    super.onAdDismissedFullScreenContent();
                    if (adCallback != null)
    ...
    void initRewardAds(Context context, String id) {
        if (AppPurchase.getInstance().isPurchased(context) || !Admob.isShowAllAds) {
            return;
        }
        this.rewardedId = id;
        RewardedAd.load(context, id, getAdRequest(), new RewardedAdLoadCallback() {
            ...
            public void onAdLoaded(@NonNull RewardedAd rewardedAd) {
                AdmobCore.this.rewardedAd = rewardedAd;
                AdmobCore.this.rewardedAd.setOnPaidEventListener(adValue -> {
    ...
    void loadNativeAd(Context context, String id, final NativeCallback callback) {
        if (AppPurchase.getInstance().isPurchased(context) || !Admob.isShowAllAds || !isNetworkConnected()) {
    ...
    void loadNativeAds(Context context, String id, int numsOfAds, final NativeCallback callback) {
        if (AppPurchase.getInstance().isPurchased(context) || !Admob.isShowAllAds || !isNetworkConnected()) {
            callback.onAdFailedToLoad();
            return;
        }
    ...
    /* =============================  Native Ads Floor  ==========================================*/
    void loadNativeAdFloor(Context context, List<String> listID, final NativeCallback callback) {
    ...
    void pushAdsToViewCustom(NativeAd nativeAd, NativeAdView adView) {
    ...
    void loadNativeFragment(final Activity mActivity, String id, View parent) {
    ...
    void setOpenActivityAfterShowInterAds(boolean openActivityAfterShowInterAds) {
    ...
    void onCheckShowSplashWhenFail(final AppCompatActivity activity, final InterCallback callback, int timeDelay) {
        if (isNetworkConnected()) {
    ...
    void onCheckShowSplashWhenFailClickButton(final AppCompatActivity activity, InterstitialAd interstitialAd, final InterCallback callback, int timeDelay) {
        if (interstitialAd != null) {
            if (isNetworkConnected()) {
                (new Handler(activity.getMainLooper())).postDelayed(new Runnable() {
                    public void run() {
    ...
    int round1000(long time) {
        return (int) (Math.round(time / 1000));
    }

    void loadSplashInterAds3(final Context context, String id, long timeDelay, final InterCallback adListener) {
        if (!isNetworkConnected() || AppPurchase.getInstance().isPurchased(context) || !Admob.isShowAllAds) {
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
    ...
    private void onShowSplash2(Activity activity, InterCallback adListener) {
        Log.e(TAG, "onShowSplash: start");
        isShowLoadingSplash = true;
        if (mInterstitialSplash == null) {
            if (dialog != null && dialog.isShowing())
    ...
    void loadAndShowInter2(AppCompatActivity activity, String idInter, int timeDelay, int timeOut, InterCallback callback) {
        if (!isNetworkConnected()) {
            callback.onAdClosed();
            callback.onNextAction();
            return;
