...
public final class NativeAdmobAdBinding implements ViewBinding {
  @NonNull
  ...
  private NativeAdmobAdBinding(@NonNull NativeAdView rootView, @NonNull TextView adAdvertiser,
  ...
  @NonNull
  public static NativeAdmobAdBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static NativeAdmobAdBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.native_admob_ad, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static NativeAdmobAdBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NativeAdmobAdBinding((NativeAdView) rootView, adAdvertiser, adAppIcon, adBody,
