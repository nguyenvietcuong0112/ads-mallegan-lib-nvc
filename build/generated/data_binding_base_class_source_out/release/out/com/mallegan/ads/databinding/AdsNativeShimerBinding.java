...
public final class AdsNativeShimerBinding implements ViewBinding {
  @NonNull
  ...
  private AdsNativeShimerBinding(@NonNull ShimmerFrameLayout rootView,
      ...
      @NonNull RelativeLayout adUnitContent, @NonNull ShimmerFrameLayout shimmerContainerNative) {
  ...
  @NonNull
  public static AdsNativeShimerBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AdsNativeShimerBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.ads_native_shimer, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AdsNativeShimerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AdsNativeShimerBinding((ShimmerFrameLayout) rootView, adAdvertiser, adAppIcon,
          adBody, adCallToAction, adHeadline, adMedia, adUnitContent, shimmerContainerNative);
    }
